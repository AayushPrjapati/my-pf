...
// The updated ResumeSection component with hover animations
const ResumeSection = () => {
  ...
  React.useEffect(() => {
    ...
    if (targetRef && targetRef.current) {
      // Use a timeout to allow the element to start expanding before scrolling
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <div className="relative">
            <div className={`absolute left-4 top-0 bottom-0 w-0.5 bg-gray-200 transition-opacity duration-500 ${hoveredSection === 'work' ? 'opacity-100' : 'opacity-0'}`}></div>
        ...
        >
          ...
          <div className="relative">
            <div className={`absolute left-4 top-0 bottom-0 w-0.5 bg-gray-200 transition-opacity duration-500 ${hoveredSection === 'education' ? 'opacity-100' : 'opacity-0'}`}></div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 pt-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Programming Languages</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">
                {hoveredSection === 'skills' ? 'Tech Interests' : 'Tech Interests / Tech Stack'}
              </h3>
               <div className={`transition-all duration-500 ease-in-out overflow-hidden ${hoveredSection === 'skills' ? 'max-h-96 opacity-100 pt-2' : 'max-h-0 opacity-0'}`}>
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2 mt-6">Tech Stack</h3>
                <div className="flex flex-wrap gap-3">
                  {techStack.map(tech => (
                     <span 
                       key={tech} 
...
// Main App component to render the ResumeSection
function App() {
  return (
